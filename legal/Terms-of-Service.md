> **TEMPLATE — NOT LEGAL ADVICE.** This document is a starting template. Debt-settlement services are heavily regulated at the federal and state level (including the FTC Telemarketing Sales Rule's advance-fee restrictions and many state-specific debt-adjuster/debt-settlement statutes, bonding, licensing, and fee-cap requirements). It must be reviewed and customized by a licensed attorney before use. Bracketed items in **[SQUARE BRACKETS]** are placeholders you must complete.
...
- **We charge no upfront fees.** You are not charged a fee simply to enroll.
...
- The full, all-in cost estimate and the estimated difference versus continuing minimum payments are shown to you before you commit. Estimates are illustrative, not guarantees.

[CONFIRM WITH COUNSEL that the fee structure and its disclosure comply with the FTC Telemarketing Sales Rule and each applicable state's debt-settlement fee rules.]
...
- **The funds in the dedicated account are yours.** You may withdraw your funds and are entitled to the funds (less any fees that have already been earned and any account-provider fees) at any time, subject to the account provider's terms.
- You authorize deposits and specific disbursements. We do not take ownership of your settlement funds.
- The account provider's separate agreement, fees, and privacy practices apply to the dedicated account, and you should review them.
...
- Make consistent deposits into your dedicated account as needed for your plan to work.
...
Please read carefully. Participation in a debt-resolution program has real risks:

- **Credit impact:** Enrolling and allowing accounts to become or remain delinquent while balances are negotiated **may negatively affect your credit** during the program. Credit recovery afterward is possible but is not guaranteed and varies by individual.
...
- **Not all debts settle:** Creditors are not required to negotiate or accept any settlement. Some accounts may not settle, and results vary based on your creditors, balances, delinquency, state, and your ability to fund your plan consistently.
- **No guarantee of results:** We do not guarantee that any debt will be settled, the amount or percentage of any reduction, the timeline, or any particular savings. All figures presented are illustrative estimates.
- **Tax consequences:** Forgiven or canceled debt may be treated as taxable income. Creditors may issue a Form 1099-C for canceled debt (generally $600 or more), although exclusions such as insolvency may apply. Consult a tax professional.
- **Not legal, tax, or financial advice:** Information we provide is for general educational purposes only and is not a substitute for advice from a qualified professional.
...
The Services are offered only in states where Debt Angel is authorized to operate and are subject to state-specific terms, fee limits, and disclosures. Program availability, pricing, and terms may vary by state. [LIST ELIGIBLE STATES OR LINK TO A STATE-AVAILABILITY PAGE.]
